                ...
                <div className="widget about-widget">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      ...
                      <a
                        href="https://www.tiktok.com/@creationhomes"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-12 h-12 bg-black hover:bg-gray-800 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                        aria-label="TikTok"
                      >
                        <svg
                          className="w-6 h-6 text-white"
              ...
              <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
                <div className="widget wpo-service-link-widget">
                  ...
                  <div className="contact-ft">
                    <ul>
                      <li>
                        <i className="fi flaticon-placeholder"></i>Griefield
                        Road, Plot 37, Nyangole Tororo Municipality, Uganda
                      </li>
                      <li>
                        <i className="fi flaticon-phone-call"></i>+256 784 971
                        942
                      </li>
                      <li>
                        <i className="fi flaticon-send"></i>
                        info@creationhomes.com
                      </li>
                    </ul>
                  </div>
                </div>
